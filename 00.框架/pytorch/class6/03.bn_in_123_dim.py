...
for i in range(2):
    # Notes: 使用PyTorch中的BN, 计算之后获取 running_mean,running_var
    outputs = bn(feature_maps_bs)
    print("\niteration:{}, running mean: {} ".format(i, bn.running_mean))
    print("iteration:{}, running var:{} ".format(i, bn.running_var))

    # Notes: 手动计算第三个特征的 running_mean,running_var
    mean_t, var_t = 3, 0
    running_mean = (1 - momentum) * running_mean + momentum * mean_t
    running_var = (1 - momentum) * running_var + momentum * var_t
    print("iteration:{}, 第3个特征的running mean: {} ".format(i, running_mean))
    print("iteration:{}, 第3个特征的running var:{}".format(i, running_var))
